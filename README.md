...
To start the web server, run either of the command below depending on your Python version, then open a web browser to http://localhost:7492/

```
# if you have Python 3
python3 -m http.server 7492

# if you have Python 2
python -m SimpleHTTPServer 7492
```
